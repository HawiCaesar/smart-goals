...
class BucketlistSmartGoalsTestCase(unittest.TestCase):
    ...
    def test_user_can_make_bucketlist(self):
        ...
        self.assertEqual(models.all_bucketlists['zreed@email.com'],
    ...
    def test_user_can_make_more_than_one_bucketlist(self):
        ...
        self.user1_bucketlist.create_bucketlist(models.all_users['jist@email.com'][1],
                                                'Career Things',
                                                'Goals to achieve in my career')
        self.user1_bucketlist.create_bucketlist(models.all_users['jist@email.com'][1],
                                                'Travel Manenos',
    ...
    def test_user_can_delete_their_bucketlist(self):
        ...
        self.user1_bucketlist.create_bucketlist(models.all_users['bhawi@gmail.com'][1],
                                                'Career Things',
                                                'Goals to achieve in my career')
        self.user1_bucketlist.create_bucketlist(models.all_users['bhawi@gmail.com'][1],
                                                'Travel Manenos',
